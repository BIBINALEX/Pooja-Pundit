...
#ifndef FIREBASE_CORE_SWIFT_H
#define FIREBASE_CORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="firebase_core",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#import <firebase_core/firebase_core.h>
...
@class FIRApp;
@class NSString;
SWIFT_CLASS_NAMED("FLTFirebaseCorePlugin")
@interface FLTFirebaseCorePlugin : NSObject <FlutterPlugin, FLTFirebasePlugin>
