...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="firebase_auth",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("FLTFirebaseAuthPlugin")
@interface FLTFirebaseAuthPlugin : NSObject <ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding, FlutterPlugin, FLTFirebasePlugin>
...
@interface FLTFirebaseAuthPlugin (SWIFT_EXTENSION(firebase_auth)) <FlutterSceneLifeCycleDelegate>
@end
